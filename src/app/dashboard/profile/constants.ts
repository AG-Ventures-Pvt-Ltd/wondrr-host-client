export const PROFILE_STATS = [
  ...
  {
    id: 2,
    label: "People Catered",
    value: "3,248",
    subtext: "+147 this month",
...
export const VERIFIED_DOCUMENTS = [
  { id: 1, name: "GST Certificate", verified: true },
  { id: 2, name: "Business Registration", verified: true },
  { id: 3, name: "Tourism License", verified: true },
